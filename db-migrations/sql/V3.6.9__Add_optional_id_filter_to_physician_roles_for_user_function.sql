...
$$
  ...
  and (id_to_find is null or pr.id = id_to_find);
$$ language sql stable;

comment on function public.get_physician_roles_for_user(uuid, uuid) is 'Get all physician roles for a user';
